...
public class BuildItemButtonWidget extends ButtonWidget {
    ...
    public void renderButton(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        fill(matrices, minX, minY, maxX, maxY, fillOpacity | (item != null ? (ItemColors.getColorForTier(item.hasMasterwork ? item.getTierFromMasterwork(item.getMinMasterwork()) : item.getTierNoMasterwork())) : 0x00000000));
